<?php namespace App\Http\Controllers;
	...
	class AdminEmployeeServiceController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->table = "employee_service";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Ref Service Type Id","name"=>"ref_service_type_id"];
