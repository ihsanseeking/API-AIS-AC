<?php namespace App\Http\Controllers;
	...
	class AdminRefVehicleTypeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "ref_brand_id,type,year,transmission";
			...
			$this->col[] = ["label"=>"Brand","name"=>"ref_brand_id","join"=>"ref_brand,name"];
			$this->col[] = ["label"=>"Type","name"=>"type"];
			$this->col[] = ["label"=>"Year","name"=>"year"];
			$this->col[] = ["label"=>"Transmission","name"=>"transmission"];
			...
			$this->form[] = ["label"=>"Ref Brand Id","name"=>"ref_brand_id","type"=>"select2","validation"=>"required|integer|min:0","width"=>"col-sm-10","datatable"=>"ref_brand,name","datatable_format"=>"name,' roda ', wheel"];
