...
define('FIREBASE_API_KEY', 'AAAAY6M1xWk:APA91bGPyB7pEdVkqk6UCT4dEqqbT7rAGgmWyGxHxlv1ZZcq3NkraLMlZNZLo0sxwirEipUOrfwNrb5iLCfEpM-WD1yhuA6-WzsG8saqpVr125dHndOcJm6EPuwV7QmsEB5wiyvu2Ohf');
	class AdminOrderController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->form[] = ["label"=>"Area Id","name"=>"area_id","type"=>"select2","validation"=>"required|integer|min:0","width"=>"col-sm-10","datatable"=>"area,id"];
			$this->form[] = ["label"=>"Is Emergency","name"=>"is_emergency","type"=>"radio","validation"=>"required|integer","width"=>"col-sm-10","dataenum"=>"Array"];
			...
			$this->form[] = ["label"=>"Status","name"=>"status","type"=>"text","validation"=>"required|min:3|max:255","width"=>"col-sm-10"];
			$this->form[] = ["label"=>"Method","name"=>"method","type"=>"text","validation"=>"required|min:3|max:255","width"=>"col-sm-10"];
