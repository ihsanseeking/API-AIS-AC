<?php namespace App\Http\Controllers;
	...
	class AdminUserController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Ref User Group Id","name"=>"ref_user_group_id","join"=>"ref_user_group,name"];
			...
			$this->form = [];
			$this->form[] = ["label"=>"Ref User Group Id","name"=>"ref_user_group_id","type"=>"select2","validation"=>"required|integer|min:0","width"=>"col-sm-10","datatable"=>"ref_user_group,name"];
